...
public class CreateWarnaCommandValidatorTests
{
    private readonly CreateWarnaCommandValidator _validator = new();

    private static CreateWarnaCommand Valid() => new("MR", "Merah", "admin");
